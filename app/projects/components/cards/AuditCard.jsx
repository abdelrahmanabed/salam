...
const AuditCard = ({ event, index }) => {
  ...
  return (
  <div
  className="group dark:text-subtextcolor  bg max-h-80 rounded-main overflow-hidden gap-0 flex flex-col rounded-xl relative bg-pinkcolor/30 hover:shadow-lg transition-all duration-300  border-transparent "
  ><div className=' p-4  pb-0'>
             ...
             <div className='flex gap-3 h-[95px] items-start'>
               ...
               <div className='flex-grow'>
                 <div className="flex justify-between items-start mb-2">
                   <div>
                     <h3 className="font-semibold text-lg mb-1"> Audit Report</h3>
             ...
             <div className='flex  bg-pinkcolor/50   mt-3 flex-wrap rounded  h-full gap-2 p-3 mb-0  dark:border-gray-800'>
          ...
          {event.uploadedBy?._id&&    <div className='h-full bg-pinkcolor/50 flex  justify-between items-center gap-2 p-3 pt-0'>
