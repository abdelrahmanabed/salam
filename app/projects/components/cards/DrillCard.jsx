...
const DrillCard = ({ event, index }) => {
  ...
  return (
  <div
  className="group dark:text-subtextcolor  bg max-h-80 rounded-main overflow-hidden gap-0 flex flex-col rounded-xl relative bg-yellowcolor/30 hover:shadow-lg transition-all duration-300  border-transparent "
  ><div className=' p-4  pb-0'>
             ...
             <div className='flex  bg-yellowcolor/50  h-full mt-3 flex-wrap rounded   gap-2 p-3 mb-0  dark:border-gray-800'>
      ...
      { event.uploadedBy._id &&<div className=' bg-yellowcolor/50 h-full flex justify-between  items-center gap-2 p-3 pt-0'>
