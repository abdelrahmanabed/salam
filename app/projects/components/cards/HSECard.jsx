...
const HSECard = ({ event, index }) => {
  ...
  return (
  <div
  className="group dark:text-subtextcolor  bg max-h-80 rounded-main overflow-hidden gap-0 flex flex-col rounded-xl relative  bg-cyancolor/30 hover:shadow-lg transition-all duration-300  border-transparent "
